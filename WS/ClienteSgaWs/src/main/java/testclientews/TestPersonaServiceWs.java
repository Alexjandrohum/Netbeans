...
public class TestPersonaServiceWs {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ejecutando salida de lista de personas");
        List<Persona> personas = personaService.listarPersonas();
        
        for(Persona persona:personas){
            System.out.println("Persona Id: "+persona.getIdpersona() + " Nombre: "+persona.getNombre()+" Apeliido: "+persona.getApellido()) ;
        }
